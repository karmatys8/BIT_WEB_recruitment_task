...
function SharedLayout() {
  ...
  useEffect(() => {
    if (storagedMode.current === null) storagedMode.current = window.localStorage.getItem("isDarkMode");
  ...
  const themeWithLocale = React.useMemo(
    () => {
      ...
      return createTheme(isDarkMode ? darkModeTheme : theme,
        locales[(languages.languages.find(lng => lng.name === locale)?.muiImportName
          || "enUS") as keyof typeof locales]);
