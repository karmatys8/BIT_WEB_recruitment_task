          ...
          <Route path="/" element={<SharedLayout />}>
            ...
            {supportedLanguagesArray.map(lng =>
              <React.Fragment key={lng}>
                <Route path={`/${lng}`} element={<Home nobelPrizes={nobelPrizes!} />}></Route>
                <Route path={`/${lng}/rewards/:year?`} element={nobelPrizes ? <YearTable nobelPrizes={nobelPrizes}/> : <div>Placeholder</div>} />
              </React.Fragment>
              )}
